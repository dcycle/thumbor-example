...
curl -I -v  http://0.0.0.0:8705/3DW-hfnrLS8eunvhonsNJe6S79I=/500x/webserver/large-image.jpg | grep 200
...
curl -I -v  http://0.0.0.0:8705/unsafe/500x/webserver/large-image.jpg | grep 400

echo "Confirming that we cannot get an image from other sources"

curl -I -v http://0.0.0.0:8705/unsafe/500x/webserver_no_access/large-image.jpg | grep 400
