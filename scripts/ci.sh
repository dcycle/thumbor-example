...
./scripts/generate-image-map.sh ./app/website-with-large-image webserver 200x ./app/website-with-large-image/unversioned-image-mapping.json webserver OPTIMIZATION
